...
if git add . && git commit -m "chore: Increment version to $NEW_VERSION [SCRIPT]" && git push "https://ozzfelipe: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@github.com/ozzfelipe/codemagic_app.git"; then
